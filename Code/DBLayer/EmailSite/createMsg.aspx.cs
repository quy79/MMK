...
namespace EmailSite
{
    public partial class createMsg : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            DataTable dtList = objMsg.SelectByUserID();
            ...
            lblTotalMsgs.Text = iTotalRecord.ToString();
        ...
        {
            if (hdAutoResponderId.Value != "0") Response.Redirect("createTextEmail.aspx?Aid=" + hdAutoResponderId.Value);
            else Response.Redirect("createTextEmail.aspx");
        }

        
        protected void lnkHTMLMail_Click(object sender, EventArgs e)
        {
            if (hdAutoResponderId.Value != "0") Response.Redirect("createHTMLEmail.aspx?Aid=" + hdAutoResponderId.Value);
            else Response.Redirect("createHTMLEmail.aspx");
        }
    }
}