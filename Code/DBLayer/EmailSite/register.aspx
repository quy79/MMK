                    	...
                    	<div class="formContent">
 							<div class="col01">
                                    ...
                                    <div class="input-field-login icon">
                                        <input name="firstname" id="firstname" autofocus="autofocus" value="" placeholder="Enter your first name." class="std_textbox" type="text" autocomplete="off" tabindex="1">
                                    </div>
									<div class="input-req-login-error">Please input First name !</div>
                                    
                                    <div style="margin-top:5px;" class="input-req-login"><label for="pass">Phone number</label></div>
                                    <div class="input-field-login icon">
                                        <input name="telephone" id="telephone" autofocus="autofocus" value="" placeholder="Enter your phone number." class="std_textbox" type="text" autocomplete="off" tabindex="3">
                                    </div>
                                    <div class="input-req-login-error">Please input Phone number !</div>
                                    
                                    <div style="margin-top:5px;" class="input-req-login"><label for="pass">City</label></div>
                                    <div class="input-field-login icon">
                                        <input name="city" id="Text1" autofocus="autofocus" value="" placeholder="Enter your phone city." class="std_textbox" type="text" autocomplete="off" tabindex="3">
                                    </div>
                                    <div class="input-req-login-error">Please input City !</div>

                                    <div style="margin-top:5px;" class="input-req-login"><label for="pass">Username</label></div>
                                    <div class="input-field-login icon">
                                        <input name="username" id="username" autofocus="autofocus" value="" placeholder="Enter your username." class="std_textbox" type="text" autocomplete="off" tabindex="5">
                                    </div>
                                    <div class="input-req-login-error">Please input Username !</div>
                                    
                                    
                                   <div style="margin-top:5px;" class="input-req-login"><label for="pass">Password</label></div>
                                    <div class="input-field-login icon">
                                        <input name="password" id="password" autofocus="autofocus" value="" placeholder="Enter your password." class="std_textbox" type="password" autocomplete="off" tabindex="7">
                                    </div>
                                    <div class="input-req-login-error">Please input password !</div>

                                    <div style="width: 220px;">
        
                                        <div class="login-btn">
                                            <button name="login" type="submit" id="login_submit" tabindex="8" onclick="javascript:window.location.href='index.html'">Register</button>
                                        </div>
							...
							<div class="col02">
                                    ...
                                    <div class="input-field-login icon">
                                        <input name="lastname" id="lastname" autofocus="autofocus" value="" placeholder="Enter your last name." class="std_textbox" type="text" autocomplete="off" tabindex="2">
                                    </div>
                                    <div class="input-req-login-error">Please input Last name !</div>
                                    
                                    <div style="margin-top:5px;" class="input-req-login"><label for="pass">Email address</label></div>
                                    <div class="input-field-login icon">
                                        <input name="email" id="email" autofocus="autofocus" value="" placeholder="Enter your email address." class="std_textbox" type="text" autocomplete="off" tabindex="4">
                                    </div>
                                    <div class="input-req-login-error">Please input Email address !</div>
                                    
                                    <div style="margin-top:5px;" class="input-req-login"><label for="pass">Provice</label></div>
                                    <div class="input-field-login icon">
                                        <input name="city" id="Text2" autofocus="autofocus" value="" placeholder="Enter your phone city." class="std_textbox" type="text" autocomplete="off" tabindex="3">
                                    </div>
                                    <div class="input-req-login-error">Please input Province !</div>

                                    <div style="margin-top:5px;" class="input-req-login"><label for="pass">Company name(optional)</label></div>
                                    <div class="input-field-login icon">
                                        <input name="companyname" id="companyname" autofocus="autofocus" value="" placeholder="Enter your username." class="std_textbox" type="text" autocomplete="off" tabindex="6">
                                    </div>
                                    <div class="input-req-login-error">Please input Company name !</div>

                                
                                   <div style="margin-top:5px;" class="input-req-login"><label for="pass">Confirm Password</label></div>
                                    <div class="input-field-login icon">
                                        <input name="password" id="password1" autofocus="autofocus" value="" placeholder="Enter your password." class="std_textbox" type="password" autocomplete="off" tabindex="7">
                                    </div>
                                    <div class="input-req-login-error">Please input password !</div>
