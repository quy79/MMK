<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="previewEmail.aspx.cs" Inherits="EmailSite.previewEmail" %>
	    ...
	    <div class="page-container">
            ...
            <div id="content-main">
            	...
            	<div id="emails-common-panel">
                    ...
                    <h2>Create an Email Message </h2>| Preview Message
                    </div>                    
                    <div class="create-message-step1-container3">
                        ...
                        <p><iframe src="messagePreview.aspx" id="message-preview" style="width: 100%; height: 500px; border: 1px green solid; ">content place holder</iframe></p>
...
<span>&nbsp;&nbsp;&nbsp;</span><a class="boldbuttons" href="http://www.dynamicdrive.com/style/"><span>Send Test Message</span></a>
                    ...
                    <div class="segment-bottom">
                        <asp:Button ID="btnSend" runat="server" Text="Send this message !" 
                            CssClass="submit3" onclick="btnSend_Click"/>
                        <asp:Button ID="btnCancel" runat="server" Text="Cancel this message" 
                            CssClass="submit3" onclick="Button2_Click"/>
